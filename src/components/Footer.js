...
const Footer = () => (
  <footer className="text-center text-white" style={{ backgroundColor: '#1e293b' }}>
    <div className="container pt-9">
      <div className="flex justify-center mb-9">
        <a href="#!" className="mr-9 text-gray-600">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
    ...
    >
      © 2021 Copyright:
      { ' ' }
      <a className="text-gray-600" href="https://github.com/GhislainMitahi/">
        Ghislain Mitahi
      </a>
    </div>
  </footer>
